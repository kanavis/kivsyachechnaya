...
SystemSettings* Inputs::system_settings() {
    std::string wifi_ssid = user_input_str("Wi-fi SSID: ", WIFI_MAX_SSID_LENGTH);
    std::string wifi_password = user_input_str("Wi-fi password: ", WIFI_MAX_PASSWORD_LENGTH, false);
